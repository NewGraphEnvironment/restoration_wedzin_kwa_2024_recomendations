...
initial_data <- tribble(
  ...
  NA, "Watershed Drainage Analysis", "Link historic and potential future sites to the freshwater atlas using the linear feature ID of stream segments and conduct watershed drainage area analysis for individual stream segments (or portions of stream segments) so that this area can be tied to other GIS and user input parameters. Functions kept in [fwapg](https://github.com/smnorris/fwapg), [fwapgr](https://github.com/poissonconsulting/fwapgr), [fwatlasbc](https://github.com/poissonconsulting/fwatlasbc) and custom functions developed for this project can be used. Results from this can be compared to other methods for determining project setbacks from the high water mark such as the [Riparian Areas Protection Regulation](https://www2.gov.bc.ca/gov/content/environment/plants-animals-ecosystems/fish/aquatic-habitat-management/riparian-areas-regulation) and the [Riparian Management Area Guidebook](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/silviculture/silvicultural-systems/silviculture-guidebooks/riparian-management-area-guidebook) [@ministryofforests1995RiparianManagement].",
  NA, "Historic Fisheries Mapping", "Spatially represent historic fisheries sites presented in Table @ref(tab:tab-hist-sites) so the option is available that potential areas of restoration can be ranked according to their proximity to these sites.",
